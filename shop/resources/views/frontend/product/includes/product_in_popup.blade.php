    ...
    $(document).on("click", ".js-addcart-detail", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // Cập nhật icon/cart count (nếu có)
                // if (response.cart_count !== undefined) {
                //     $("#cart-count").text(response.cart_count);
                // }

                $.ajax({
                    url: "{{ route('cart.component') }}", // cần route riêng để trả về view giỏ hàng nhanh
                    method: "GET",
                    success: function(html) {
                        $("#cart-component").html(html); // div chứa component giỏ hàng
                    }
                });
            },
            error: function(xhr) {
