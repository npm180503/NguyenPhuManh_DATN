                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 product-item {{ $index < 8 ? 'initial' : 'hidden' }}">
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            ...
                            <a href="#"
                                class="block2-btn flex-c-m stext-103 trans-04 js-show-modal1"
                                data-id="{{ $product->id }}"
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l">
                                <a href="{{ route('fr.product.detail', ['productID' => $product->id]) }}" class="stext-104 p-b-6">
                                    {{ $product->name }}
                                </a>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-6 col-md-2 brand-item">
                <div class="brand-box">
                    <img src="/template/admin/dist/img/nike.png" alt="Nike">
                </div>
            </div>
            <div class="col-6 col-md-2 brand-item">
                <div class="brand-box">
                    <img src="/template/admin/dist/img/adidas.png" alt="Adidas">
                </div>
            </div>
            <div class="col-6 col-md-2 brand-item">
                <div class="brand-box">
                    <img src="/template/admin/dist/img/jordan.png" alt="Jordan">
                </div>
            </div>
            <div class="col-6 col-md-2 brand-item">
                <div class="brand-box">
                    <img src="/template/admin/dist/img/asics.png" alt="Asics">
                </div>
            </div>
            <div class="col-6 col-md-2 brand-item">
                <div class="brand-box">
                    <img src="/template/admin/dist/img/babolat.png" alt="Babolat">
                </div>
            </div>
            <div class="col-6 col-md-2 brand-item">
                <div class="brand-box">
                    <img src="/template/admin/dist/img/newbalance.png" alt="New Balance">
                </div>
            </div>
        </div>
    </div>
